...
var stdApexClasses = 
    ['Action', 'AggregateColumn', 'Announcements', 'Answers', 'ApexPages', 'Approval', 'AuthConfiguration', 'AuthToken', 'Blob', 'Boolean', 'BusinessHours', 'Chatter', 'ChatterFavorites', 'ChatterFeeds', 'ChatterGroups', 'ChatterMessages', 'ChatterUsers', 'ChildRelationship', 'Communities', 'CommunitiesUtil', 'CommunityModeration', 'Component', 'Cookie', 'Crypto', 'DMLOptions', 'DataCategory', 'DataCategoryGroupSobjectTypePair', 'Database', 'Date', 'DateTime', 'Datetime', 'Decimal', 'DeleteResult', 'DeletedRecord', 'DescribeAvailableQuickActionResult', 'DescribeColorResult', 'DescribeFieldResult', 'DescribeIconResult', 'DescribeLayoutComponent', 'DescribeLayoutItem', 'DescribeLayoutRow', 'DescribeLayoutSection', 'DescribeQuickActionDefaultValue', 'DescribeQuickActionResult', 'DescribeSObjectResult', 'DescribeTabResult', 'DescribeTabSetResult', 'DetailColumn', 'Dimension', 'DmlOptions', 'Document', 'Double', 'EmailFileAttachment', 'EmptyRecycleBinResult', 'EncodingUtil', 'Error', 'FieldSet', 'FieldSetMember', 'FilterOperator', 'FilterValue', 'GetDeletedResult', 'GetUpdatedResult', 'GroupingColumn', 'GroupingInfo', 'GroupingValue', 'HTTP', 'HTTPRequest', 'HTTPResponse', 'Http', 'HttpRequest', 'HttpResponse', 'ID', 'Id', 'IdeaStandardController', 'IdeaStandardSetController', 'Ideas', 'InboundEmail', 'InboundEmailResult', 'InboundEnvelope', 'Integer', 'Interview', 'JSON', 'JSONGenerator', 'JSONParser', 'KnowledgeArticleVersionStandardController', 'LeadConvert', 'LeadConvertResult', 'Limits', 'List', 'Long', 'Map', 'MassEmailMessage', 'Matcher', 'Math', 'Mentions', 'MergeResult', 'Message', 'Messaging', 'MultiStaticResourceCalloutMock', 'Network', 'Organization', 'Pattern', 'PicklistEntry', 'PluginDescribeResult', 'PluginRequest', 'PluginResult', 'ProcessRequest', 'ProcessResult', 'ProcessSubmitRequest', 'ProcessWorkitemRequest', 'PublishingService', 'QueryLocator', 'QueryLocatorIterator', 'QuickAction', 'QuickActionRequest', 'QuickActionResult', 'RecordTypeInfo', 'Records', 'ReportCurrency', 'ReportDataCell', 'ReportDescribeResult', 'ReportDetailRow', 'ReportExtendedMetadata', 'ReportFact', 'ReportFactWithDetails', 'ReportFilter', 'ReportInstance', 'ReportManager', 'ReportMetadata', 'ReportResults', 'ReportType', 'ReportTypeColumn', 'ReportTypeColumnCategory', 'ReportTypeMetadata', 'ResetPasswordResult', 'RestContext', 'RestRequest', 'RestResponse', 'SObject', 'SObjectField', 'SObjectType', 'SaveResult', 'Schema', 'Search', 'SelectOption', 'SendEmailError', 'SendEmailResult', 'SessionManagement', 'Set', 'Site', 'StandardController', 'StandardSetController', 'StaticResourceCalloutMock', 'String', 'SummaryValue', 'System', 'Test', 'Time', 'TimeZone', 'Timezone', 'Topics', 'Type', 'URL', 'UndeleteResult', 'UpsertResult', 'Url', 'UserData', 'UserInfo', 'UserProfiles', 'Version', 'WebServiceCallout', 'XMLNode', 'XMLStreamReader', 'XMLStreamWriter', 'XmlNode', 'XmlStreamReader', 'XmlStreamWriter', 'Zones', 'sObject', 'sObjectField', 'sObjectType'];
    
var stdApexObjects = 
	['AcceptedEventRelation', 'Account', 'AccountContactRole', 'AccountFeed', 'AccountHistory', 'AccountOwnerSharingRule', 'AccountPartner', 'AccountShare', 'AccountTag', 'AccountTeamMember', 'AccountTerritoryAssignmentRule', 'AccountTerritoryAssignmentRuleItem', 'AccountTerritorySharingRule', 'ActivityHistory', 'AdditionalNumber', 'AllowedEmailDomain', 'ApexClass', 'ApexComponent', 'ApexLog', 'ApexPage', 'ApexTestQueueItem', 'ApexTestResult', 'ApexTrigger', 'Approval', 'Asset', 'AssetFeed', 'AssetTag', 'AssignmentRule', 'AsyncApexJob', 'AttachedContentDocument', 'Attachment', 'AuthConfig', 'AuthConfigProviders', 'AuthProvider', 'AuthSession', 'Bookmark', 'BrandTemplate', 'BusinessHours', 'BusinessProcess', 'CallCenter', 'Campaign', 'CampaignFeed', 'CampaignMember', 'CampaignMemberStatus', 'CampaignOwnerSharingRule', 'Campaign', 'CampaignShare', 'CampaignTag', 'Case', 'CaseArticle', 'CaseComment', 'CaseContactRole', 'CaseFeed', 'CaseHistory', 'CaseMilestone', 'CaseOwnerSharingRule', 'CaseShare', 'CaseSolution', 'Solution', 'CaseStatus', 'CaseTag', 'CaseTeamMember', 'CaseTeamRole', 'CaseTeamTemplate', 'CaseTeamTemplateMember', 'CaseTeamTemplateRecord', 'CategoryData', 'CategoryNode', 'CategoryNodeLocalization', 'ChatterActivity', 'ChatterAnswersActivity', 'ChatterAnswersReputationLevel', 'ChatterAnswersReputationLevel', 'ChatterConversation', 'ChatterConversationMember', 'ChatterMessage', 'CollaborationGroup', 'CollaborationGroupFeed', 'CollaborationGroupMember', 'CollaborationGroupMemberRequest', 'CollaborationInvitation', 'CombinedAttachment', 'Community (Zone)', 'Zone', 'Contact', 'ContactFeed', 'ContactHistory', 'ContactOwnerSharingRule', 'ContactShare', 'ContactTag', 'ContentDocument', 'ContentDocumentFeed', 'ContentDocumentHistory', 'ContentDocumentLink', 'ContentVersion', 'ContentVersionHistory', 'ContentWorkspace', 'ContentWorkspaceDoc', 'Contract', 'ContractContactRole', 'ContractFeed', 'ContractHistory', 'ContractLineItem', 'ContractLineItemHistory', 'ContractStatus', 'ContractTag', 'CronTrigger', 'CronJobDetail', 'CurrencyType', 'CustomBrand', 'CustomBrandAsset', 'CustomPermission', 'CustomPermissionDependency', 'DandBCompany', 'Dashboard', 'DashboardComponent', 'DashboardComponentFeed', 'DashboardFeed', 'DashboardTag', 'DatacloudCompany', 'DatacloudContact', 'DatacloudDandBCompany', 'DatacloudOwnedEntity', 'DatacloudPurchaseUsage', 'DatacloudSocialHandle', 'DatedConversionRate', 'DeclinedEventRelation', 'Division', 'DivisionLocalization', 'Document', 'DocumentAttachmentMap', 'DocumentTag', 'EmailMessage', 'EmailServicesAddress', 'EmailServicesFunction', 'EmailStatus', 'EmailTemplate', 'Entitlement', 'EntitlementContact', 'EntitlementFeed', 'EntitlementHistory', 'EntitlementTemplate', 'EntityHistory', 'EntitySubscription', 'EnvironmentHubMember', 'Event', 'EventFeed', 'EventRelation', 'EventTag', 'EventWhoRelation', 'EventRelation', 'ExternalDataSource', 'ExternalDataUserAuth', 'FeedComment', 'FeedItem', 'FeedLike', 'FeedPollChoice', 'FeedPollVote', 'FeedPost', 'FeedTrackedChange', 'FieldPermissions', 'FiscalYearSettings', 'Folder', 'ForecastingAdjustment', 'ForecastingFact', 'ForecastingItem', 'ForecastingQuota', 'ForecastShare', 'Group', 'GroupMember', 'HashtagDefinition', 'Holiday', 'Idea', 'IdeaComment', 'IdeaTheme', 'KnowledgeableUser', 'KnowledgeArticle', 'KnowledgeArticleVersion', 'KnowledgeArticleVersionHistory', 'KnowledgeArticleViewStat', 'KnowledgeArticleVoteStat', 'Lead', 'LeadFeed', 'LeadHistory', 'LeadOwnerSharingRule', 'LeadShare', 'LeadStatus', 'LeadTag', 'LimitAllocationPerApp', 'LineitemOverride', 'LoginHistory', 'LookedUpFromActivity', 'MailmergeTemplate', 'MilestoneType', 'Name', 'Network', 'NetworkActivityAudit', 'NetworkMember', 'NetworkMemberGroup', 'NetworkModeration', 'NewsFeed', 'Note', 'NoteAndAttachment', 'NoteTag', 'ObjectPermissions', 'ObjectTerritory2AssignmentRule', 'ObjectTerritory2AssignmentRuleItem', 'ObjectTerritory2Association', 'OpenActivity', 'Opportunity', 'OpportunityCompetitor', 'OpportunityContactRole', 'OpportunityFeed', 'OpportunityFieldHistory', 'OpportunityHistory', 'OpportunityLineItem', 'OpportunityLineItemSchedule', 'OpportunityOverride', 'OpportunityOwnerSharingRule', 'OpportunityPartner', 'OpportunityShare', 'OpportunitySplit', 'OpportunitySplitType', 'OpportunityStage', 'OpportunityTag', 'OpportunityTeamMember', 'Order', 'OrderFeed', 'OrderHistory', 'OrderItem', 'OrderItemFeed', 'OrderItemHistory', 'Organization', 'OrgWideEmailAddress', 'OwnedContentDocument', 'PackageLicense', 'Partner', 'PartnerNetworkConnection', 'PartnerNetworkRecordConnection', 'PartnerRole', 'Period', 'PermissionSet', 'PermissionSetAssignment', 'Pricebook2', 'Pricebook2History', 'PricebookEntry', 'ProcessDefinition', 'ProcessInstance', 'ProcessInstanceHistory', 'ProcessInstanceNode', 'ProcessInstanceStep', 'ProcessInstanceWorkitem', 'ProcessNode', 'Product2', 'Product2Feed', 'ProductEntitlementTemplate', 'Profile', 'ProfileSkill', 'ProfileSkillEndorsement', 'ProfileSkillEndorsementHistory', 'ProfileSkillFeed', 'ProfileSkillHistory', 'ProfileSkillShare', 'ProfileSkillUser', 'ProfileSkillUserHistory', 'PushTopic', 'QuantityForecast', 'QuantityForecastHistory', 'Question', 'QuestionDataCategorySelection', 'QuestionReportAbuse', 'QuestionSubscription', 'QueueSobject', 'Quote', 'QuoteDocument', 'QuoteLineItem', 'RecentlyViewed', 'RecordType', 'RecordTypeLocalization', 'Reply', 'ReplyReportAbuse', 'Report', 'ReportFeed', 'ReportTag', 'RevenueForecast', 'RevenueForecastHistory', 'RuleTerritory2Association', 'Scontrol', 'ScontrolLocalization', 'SelfServiceUser', 'ServiceContract', 'ServiceContractFeed', 'ServiceContractHistory', 'ServiceContractOwnerSharingRule', 'ServiceContractShare', 'SetupEntityAccess', 'SignupRequest', 'Site', 'SiteHistory', 'SlaProcess', 'Solution', 'SolutionFeed', 'SolutionHistory', 'SolutionStatus', 'SolutionTag', 'StaticResource', 'StreamingChannel', 'TagDefinition', 'Task', 'TaskFeed', 'TaskPriority', 'TaskRelation', 'TaskStatus', 'TaskTag', 'TaskWhoRelation', 'TaskRelation', 'Territory', 'Territory2', 'Territory2Model', 'Territory2ModelHistory', 'Territory2Type', 'ThirdPartyAccountLink', 'Topic', 'TopicAssignment', 'TopicFeed', 'TwoFactorInfo', 'UndecidedEventRelation', 'User', 'UserAccountTeamMember', 'UserConfigTransferButton', 'UserConfigTransferSkill', 'UserFeed', 'UserLicense', 'UserLogin', 'UserMembershipSharingRule', 'UserPackageLicense', 'UserPreference', 'UserProfile', 'UserProfileFeed', 'UserRecordAccess', 'UserRole', 'UserShare', 'UserTeamMember', 'UserTerritory', 'UserTerritory2Association', 'Vote', 'WebLink', 'WebLinkLocalization', 'WorkAccess', 'WorkAccessShare', 'WorkBadge', 'WorkBadgeDefinition', 'WorkBadgeDefinitionHistory', 'WorkBadgeDefinitionShare', 'WorkCoaching', 'WorkCoachingFeed', 'WorkCoachingHistory', 'WorkCoachingShare', 'WorkFeedback', 'WorkFeedbackHistory', 'WorkFeedbackQuestion', 'WorkFeedbackQuestionHistory', 'WorkFeedbackQuestionSet', 'WorkFeedbackQuestionSetHistory', 'WorkFeedbackQuestionSetShare', 'WorkFeedbackQuestionShare', 'WorkFeedbackRequest', 'WorkFeedbackRequestFeed', 'WorkFeedbackRequestHistory', 'WorkFeedbackRequestShare', 'WorkFeedbackShare', 'WorkGoal', 'WorkGoalCollaborator', 'WorkGoalCollaboratorHistory', 'WorkGoalFeed', 'WorkGoalHistory', 'WorkGoalLink', 'WorkGoalShare', 'WorkPerformanceCycle', 'WorkPerformanceCycleFeed', 'WorkPerformanceCycleHistory', 'WorkPerformanceCycleShare', 'WorkReward', 'WorkRewardFund', 'WorkRewardFundHistory', 'WorkRewardFundShare', 'WorkRewardFundType', 'WorkRewardFundTypeHistory', 'WorkRewardFundTypeShare', 'WorkRewardHistory', 'WorkRewardShare', 'WorkThanks', 'WorkThanksShare'];

var customApexClasses = [];

var apexKeywords = ['abstract', 'activate', 'and', 'AND', 'any', 'array', 'as', 'asc', 'ASC', 'autonomous', 'begin', 'bigdecimal', 'blob', 'break', 'bulk', 'by', 'BY', 'byte', 'case', 'cast', 'catch', 'char', 'class', 'collect', 'commit', 'const', 'continue', 'convertcurrency', 'convertCurrency', 'decimal', 'default', 'delete', 'desc', 'DESC', 'do', 'else', 'end', 'enum', 'exception', 'exit', 'export', 'extends', 'false', 'final', 'finally', 'float', 'for', 'from', 'FROM', 'future', 'global', 'goto', 'group', 'having', 'HAVING', 'hint', 'if', 'implements', 'import', 'inner', 'insert', 'instanceof', 'instanceOf', 'interface', 'into', 'int', 'join', 'last_90_days', 'LAST_90_DAYS', 'last_month', 'LAST_MONTH', 'last_n_days', 'LAST_N_DAYS', 'last_week', 'LAST_WEEK', 'like', 'LIKE', 'limit', 'LIMIT', 'list', 'long', 'loop', 'map', 'merge', 'new', 'next_90_days', 'NEXT_90_DAYS', 'next_month', 'NEXT_MONTH', 'next_n_days', 'NEXT_N_DAYS', 'next_week', 'NEXT_WEEK', 'not', 'NOT', 'null', 'nulls', 'number', 'object', 'of', 'on', 'or', 'OR', 'order', 'ORDER', 'outer', 'override', 'package', 'parallel', 'pragma', 'private', 'protected', 'public', 'retrieve', 'return', 'returning', 'rollback', 'savepoint', 'search', 'SEARCH', 'select', 'SELECT', 'set', 'short', 'sort', 'stat', 'static', 'super', 'switch', 'synchronized', 'system', 'testmethod', 'testMethod', 'then', 'this', 'this_month', 'THIS_MONTH', 'this_week', 'THIS_WEEK', 'throw', 'today', 'TODAY', 'tolabel', 'toLabel', 'tomorrow', 'TOMORROW', 'transaction', 'trigger', 'true', 'try', 'type', 'undelete', 'update', 'upsert', 'using', 'virtual', 'void', 'webservice', 'webService', 'when', 'where', 'WHERE', 'while', 'yesterday', 'YESTERDAY'];
...
var apexLang = {
    ...
    "webservicecallout": {
        "staticMethods": [{
            "type": "void",
            "name": "invoke",
            "parameters": ["(Object stub, Object request, Map response, List<String> info)"]
        }],
        "instanceMethods": [],
        "properties": [],
        "constructors": []
